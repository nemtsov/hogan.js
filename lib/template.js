...
(function (Hogan) {
  ...
  Hogan.Template.prototype = {
    ...
    ep: function(symbol, partials) {
      ...
      var key = compareSubs(template);
      if (partial.instanceMap && partial.instanceMap.has(key) && partial.base == template) {
        return partial.instanceMap.get(key);
      }
      ...
      this.partials[symbol].instanceMap = this.partials[symbol].instanceMap || new Map();
      this.partials[symbol].instanceMap.set(compareSubs(partial), template);
